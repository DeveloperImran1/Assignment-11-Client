    ...
    return (
        ...
        <div className="mx-auto max-w-[350px] space-y-6 rounded-xl bg-white px-4 pb-8 pt-4 font-sans shadow-lg  dark:bg-[#18181B]">
                ...
                >
                    <SwiperSlide>
                        <div className="relative group">
                            ...
                            <img width={300} height={300} className="h-[300px] w-full rounded-lg bg-black/40" src={RoomImages?.[0] || 'https://source.unsplash.com/300x300/?macbook' } alt="card navigate ui" />
                    ...
                    <SwiperSlide>
                        <div className="relative group">
                            ...
                            <img width={300} height={300} className="h-[300px] w-full rounded-lg bg-black/40" src={RoomImages?.[1] || 'https://source.unsplash.com/300x300/?macbook' } alt="card navigate ui" />
                            <div className=" size-1 p-[3px]  flex justify-center items-center absolute top-3 right-1 group-hover:w-full group-hover:h-full group-hover:top-0 group-hover:right-0 group-hover:bg-blue-100/60 duration-500 transition-all">
                    ...
                    <SwiperSlide>
                        <div className="relative group">
                            ...
                            <img width={300} height={300} className="h-[300px] w-full rounded-lg bg-black/40" src={RoomImages?.[2] || 'https://source.unsplash.com/300x300/?macbook' } alt="card navigate ui" />
                            <div className=" size-1 p-[3px]  flex justify-center items-center absolute top-3 right-1 group-hover:w-full group-hover:h-full group-hover:top-0 group-hover:right-0 group-hover:bg-blue-100/60 duration-500 transition-all">
            ...
            <div className="flex mx-auto flex-wrap w-[90%] items-center justify-between gap-6 text-sm md:text-base">
                <Link to={`/rooms/${_id}`} >  <button className="rounded-lg bg-[#49B2FF] px-4 py-2 font-sans font-semibold text-white duration-300 hover:scale-105 hover:bg-sky-600">Book now</button></Link>
