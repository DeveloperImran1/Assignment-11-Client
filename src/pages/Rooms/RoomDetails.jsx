        ...
        <div>
            ...
            <div className="w-full lg:w-[90%] mx-auto flex  items-center justify-center p-5 border-2 rounded-2xl">
                <div className="flex flex-col gap-12 rounded-lg  w-full">
                    ...
                    <div className="text-[24px] font-semibold -my-10 flex justify-between ">
                    ...
                    <div className="grid grid-cols-3 gap-4 w-full h-[400px]" >
                        <img alt="" className="w-full h-full  rounded shadow-sm col-span-2 row-span-2  dark:bg-gray-500 " src={`https://i.ibb.co/k3LwX3C/folio-img2-1-1536x960.jpg`} />
                        <img alt="" className="w-full h-full row-span-1 rounded shadow-sm  dark:bg-gray-500 " src="https://i.ibb.co/k3LwX3C/folio-img2-1-1536x960.jpg" />
                        <img alt="" className="w-full h-full row-span-1 rounded shadow-sm  dark:bg-gray-500 " src="https://i.ibb.co/k3LwX3C/folio-img2-1-1536x960.jpg" />
