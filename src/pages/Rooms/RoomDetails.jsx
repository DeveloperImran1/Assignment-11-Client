            ...
            <div className="w-full lg:w-[90%] mx-auto flex  items-center justify-center p-5 border-2 rounded-2xl">
                <div className="flex flex-col gap-12 rounded-lg  w-full">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 w-full h-full" >
                        <img alt="" className="w-full h-full  rounded shadow-sm lg:col-span-2 lg:row-span-2  dark:bg-gray-500 " src={`https://i.ibb.co/k3LwX3C/folio-img2-1-1536x960.jpg`} />
                        <img alt="" className="w-full h-full lg:row-span-1 rounded shadow-sm  dark:bg-gray-500 " src="https://i.ibb.co/k3LwX3C/folio-img2-1-1536x960.jpg" />
                        <img alt="" className="w-full h-full lg:row-span-1 rounded shadow-sm  dark:bg-gray-500 " src="https://i.ibb.co/k3LwX3C/folio-img2-1-1536x960.jpg" />
