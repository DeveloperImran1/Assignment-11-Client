...
const FeaturedRooms = () => {
    return (
        <div>
            ...
            <Marquee>
                <div className="h-[300px] w-[320px] border-2 " >
                    <div className="relative group">
                        <img className=" border-2 border-blue-300 bg-slate-500 object-cover" src="https://i.ibb.co/ryVDcqF/folio-img7-1536x960.jpg" alt="avatar navigate ui" />
                        <div className="bg-blue-100 size-6 p-[3px]  flex justify-center items-center absolute top-3 right-1 group-hover:w-full group-hover:h-full group-hover:top-0 group-hover:right-0 group-hover:bg-blue-100/60 duration-500 transition-all">
